...
(let* ((bg "#111010")
      (err "#d45a48")
      (err-container "#5d170c")
      (on-background "#e0e4e8")
      (on-err "#111010")
      (on-err-container "#f5dad6")
      (on-primary "#111010")
      (on-primary-container "#d2e3f9")
      (on-secondary "#111010")
      (on-secondary-container "#d6dff5")
      (on-surface "#e0e4e8")
      (on-surface-variant "#80858a")
      (on-tertiary "#111010")
      (on-tertiary-container "#02151f")
      (outline-color "#5c6163")
      (outline-variant "#373a3b")
      (primary "#4e92e8")
      (primary-container "#053b7e")
      (secondary "#305ac4")
      (secondary-container "#091a43")
      (shadow "#111010")
      (surface "#111010")
      (surface-container "#1a1b1c")
      (surface-container-high "#242527")
      (surface-container-highest "#2e2f31")
      (surface-container-low "#151516")
      (surface-container-lowest "#121212")
      (surface-variant "#1a1b1c")
      (tertiary "#81d0f7")
      (tertiary-container "#0084c6")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#81d0f7")
      (on-success "#111010")
      (success-container "#0084c6")
      (on-success-container "#02151f")
      ;; Map fixed colors to regular colors
      (primary-fixed "#4e92e8")
      (primary-fixed-dim "#053b7e")
      (secondary-fixed "#305ac4")
      (secondary-fixed-dim "#091a43")
      (tertiary-fixed "#81d0f7")
      (tertiary-fixed-dim "#0084c6")
      (on-primary-fixed "#111010")
      (on-primary-fixed-variant "#d2e3f9")
      (on-secondary-fixed "#111010")
      (on-secondary-fixed-variant "#d6dff5")
      (on-tertiary-fixed "#111010")
      (on-tertiary-fixed-variant "#02151f")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#e0e4e8")
      (inverse-primary "#4e92e8")
      (inverse-surface "#111010")
